...
alias less='less -R'
alias sl='sl -wed'
alias ruststd-doc='xdg-open $(dirname $(which rustc))/../share/doc/rust/html/std/index.html'
alias adbw='adb wait-for-device && adb '
alias sudo='sudo ' # For use of alias after sudo
# alias untar="tar -xvf "
